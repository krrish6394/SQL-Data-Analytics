...
CONFIG = _cleanup(
    {
        "Compilers": {
            ...
            "pythran": {
                "version": "0.13.1",
                "include directory": r"../../pip-build-env-c59p96qu/overlay/lib/python3.10/site-packages/pythran"
            },
        },
        "Machine Information": {
            "host": {
        ...
        "Python Information": {
            "path": r"/private/var/folders/76/zy5ktkns50v6gt5g8r0sf6sc0000gn/T/cibw-run-ie8qdf2r/cp310-macosx_arm64/build/venv/bin/python",
            "version": "3.10",
        },
    }
)
